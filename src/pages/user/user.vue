...
import {reqUserlist,reqUserInfo,reqUserCount} from "../../utils/http"
export default {
  components:{
 vList,
 vAdd
  ...
  reqlist(num){
     ...
     if(!num){
       num=this.pagNo
      console.log(num,this.list,"22222222222222")
     ...
     reqUserCount().then(res=>{
       ...
       this.total=res.data.list[0].total
          // console.log( res.data.list[0].total,"00000000")

      })



   reqUserlist(num).then(res=>{
